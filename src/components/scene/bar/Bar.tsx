const Bar = () => {
  return (
    <div className="w-6/12 h-4/6">
      ...
      <div className="w-[129px] md:w-[200px] h-[80px] md:h-[100px]  flex relative  left-[70px] bottom-[300px] border border-l-0 border-b-0 border-t-[10px] border-r-[10px] border-neutral-400 rounded-tr-xl"></div>
